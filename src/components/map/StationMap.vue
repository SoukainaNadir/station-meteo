  ...
  <v-card class="map-container">
    ...
    <v-dialog v-model="showStationDialog" max-width="500">
      <v-card v-if="selectedStation">
        ...
        <v-card-text class="pt-4">
          <v-list>
            <v-list-item>
              ...
              <v-list-item-title>
                {{ selectedStation.measurements?.temperature?.value }}°C
              </v-list-item-title>
            ...
            <v-list-item>
              ...
              <v-list-item-title>
                {{ selectedStation.measurements?.humidity?.value }}%
              </v-list-item-title>
            ...
            <v-list-item>
              ...
              <v-list-item-title>
                {{ selectedStation.measurements?.wind_speed?.value }} km/h
              </v-list-item-title>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="primary" variant="text" @click="showStationDialog = false">
            Fermer
          </v-btn>
